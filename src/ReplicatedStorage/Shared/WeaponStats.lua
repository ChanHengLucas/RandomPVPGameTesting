--[[
	...
	affinity: "angelic" | "demonic" for Angelic/Demonic multiplier
...
return {
	...
	AngelicSwordTool = { damage = 46, range = 8, cooldown = 0.55, affinity = "angelic" },
	DemonicSwordTool = { damage = 46, range = 8, cooldown = 0.55, affinity = "demonic" },
	...
	AngelicSpearTool = { damage = 34, range = 12, cooldown = 0.45, pierce = 0.30, affinity = "angelic" },
	DemonicSpearTool = { damage = 34, range = 12, cooldown = 0.45, pierce = 0.30, affinity = "demonic" },
	...
	AngelicAxeTool = { damage = 52, range = 8, cooldown = 0.75, pierce = 0.10, affinity = "angelic" },
	DemonicAxeTool = { damage = 52, range = 8, cooldown = 0.75, pierce = 0.10, affinity = "demonic" },
	...
	AngelicPickaxeTool = { damage = 22, range = 8, cooldown = 0.70, affinity = "angelic" },
	DemonicPickaxeTool = { damage = 22, range = 8, cooldown = 0.70, affinity = "demonic" },
